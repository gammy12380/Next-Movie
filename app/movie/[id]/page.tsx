			...
			<section className="flex max-sm:flex-col gap-8 p-4 bg-[#686B721A] xl:rounded-[20px]">
				{
					movieBanner ?
						<div className="relative max-sm:w-full sm:w-80 sm:min-w-80 sm:h-[480px]">
							<LazyImage src={`https://image.tmdb.org/t/p/original/${movieBanner}`} alt={movie.title} imgClass="size-full aspect-[2/3] object-cover rounded-[20px]" />
						...
						: <div className="flex items-center justify-center max-sm max-sm:w-full aspect-[2/3] sm:w-80 sm:h-[480px] sm:aspect-[2/3] object-cover rounded-[20px]">
